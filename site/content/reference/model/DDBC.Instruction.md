...
description = "The DDBC.Instruction type of the S2 energy flexibility standard: its fields, their types, and which are required."
[extra]
generated = true
+++
...
| `operation_mode_factor` | `float` | **yes** | The number indicates the factor with which the `OMBC.OperationMode` should be configured. The factor should be greater than or equal to 0 and less or equal to 1. |
