...
description = "The OMBC.Instruction type of the S2 energy flexibility standard: its fields, their types, and which are required."
[extra]
generated = true
+++
...
| `operation_mode_id` | `ID` | **yes** | ID of the `OMBC.OperationMode` that should be activated |
